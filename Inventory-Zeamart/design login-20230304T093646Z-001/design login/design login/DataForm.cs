...
namespace design_login
{
    public partial class DataForm : Form
    {
        ...
        {
            dgv_toko.DataSource = getToko();

            DataGridViewButtonColumn colEdit = new DataGridViewButtonColumn();
            colEdit.UseColumnTextForButtonValue = true;
            colEdit.Text = "Edit";
            colEdit.Name = " ";
            dgv_toko.Columns.Add(colEdit);

            DataGridViewButtonColumn colDelete = new DataGridViewButtonColumn();
            colDelete.UseColumnTextForButtonValue = true;
            colDelete.Text = "Delete";
            colDelete.Name = " ";
            dgv_toko.Columns.Add(colDelete);
        }
        ...
        private void dgv_toko_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if(e.ColumnIndex == 4)
            {
                int id = Convert.ToInt32(dgv_toko.CurrentCell.RowIndex.ToString());
                textBox7.Text = dgv_toko.Rows[id].Cells[0].Value.ToString();
                textBox6.Text = dgv_toko.Rows[id].Cells[1].Value.ToString();
                textBox5.Text = dgv_toko.Rows[id].Cells[2].Value.ToString();
                textBox1.Text = dgv_toko.Rows[id].Cells[3].Value.ToString();
            ...
            if (e.ColumnIndex == 5)
            {
                ...
                try
                {
                    ...
                    cmd.Parameters.AddWithValue("@id", dgv_toko.Rows[id].Cells[0].Value.ToString());
                    cmd.ExecuteNonQuery();
        ...
        private void dgv_toko_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
